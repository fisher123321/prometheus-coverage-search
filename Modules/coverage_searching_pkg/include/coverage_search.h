#ifndef COVERAGE_SEARCH_H
#define COVERAGE_SEARCH_H
...
#include "coverage_console_colors.h"
...
private:
    void publishUnknownBoundaryDebug();
    ...
    int queue_size_;
    int st_it_;
    bool debug_unknown_boundary_vis_;
...
private:
    ...
    ros::Timer mainloop_timer_, frontier_timer_;
